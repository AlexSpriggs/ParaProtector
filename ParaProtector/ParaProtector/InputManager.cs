...
namespace ParaProtector
{
    public class TextInputRecord
    {
        ...
        /// <summary>
        /// Whether or not the carotLocation property should be automatically updated. Use i.e. if a textbox goes in or out of focus.
        /// </summary>
        public bool disableCarotUpdate = false;
    ...
    public class InputManager
    {
        ...
        /// <summary>
        /// Access input using master authority. i.e. Cutscenes.
        /// </summary>
        ...
        public void UpdateInput()
        {
            ...
            if (m_HoldKey != (Keys)0)
            {
                ...
                else
                {
                    ...
                    {
                        //	Wait for the threshold to start signalling
        ...
        /// TODO: Implement (Need to figure out the best way to handle the analog sticks, having "true/false" isn't appropriate)
        /// </summary>
        /// <param name="binding">Name of the identifier to be bound to.</param>
        ...
        public bool CheckMouseLeftPressed(uint authKey)
        {
            if (!PassesAuthorityCheck(authKey))
                return false;
            else
        ...
        public bool CheckMouseRightPressed(uint authKey)
        {
            if (!PassesAuthorityCheck(authKey))
                return false;
            else
